...
<head>
    ...
    <style>
        * {
        ...
        .action-lux-btn:active { transform: scale(0.98); }
        ...
        .spread-card-item:hover { transform: translateY(-10px); }
...
<body>
    ...
    <div class="container">
        ...
        <!-- Daily Lucky Wallpaper Section -->
        <div class="wallpaper-section">
            <h3 style="color: #f3e76e; font-size: 15px; margin-bottom: 10px;">✨ ယနေ့အတွက် ကံကောင်းစေမည့် Wallpaper ✨</h3>
            <img id="dailyWallpaperImg" src="https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=500&auto=format&fit=crop&q=60" alt="Lucky Wallpaper" style="width: 100%; max-width: 220px; height: auto; border-radius: 12px; border: 1px solid #d4af37; box-shadow: 0 4px 15px rgba(212, 175, 55, 0.3);">
            <p style="font-size: 11px; color: #e9d5ff; margin-top: 8px;">ပုံကို ဖိ၍ ဖုန်းမှာ Download ဆွဲသုံးနိုင်ပါသည်</p>
        </div>
    ...
    <script>
        ...
        function startShuffle() {
            ...
            cards.forEach((card, idx) => {
                card.style.transform = `translate(${Math.random()*40 - 20}px, ${Math.random()*20 - 10}px) rotate(${Math.random()*30 - 15}deg)`;
            });
